...
namespace OzonEdu.MerchandiseService.Infrastructure.DomainEvents.EmployeeAggregate
{
        ...
        : INotificationHandler<EmployeeFinishedProbationPeriodDomainEvent>
    {
        ...
        public EmployeeFinishedProbationPeriodDomainEventHandler(IApplicationService applicationService) =>
            ...
            CancellationToken cancellationToken = default)
        {
            ...
            var merchPack =
                await _applicationService.GetMerchPackAsync((int) MerchType.ProbationPeriodEndingPack,
                    cancellationToken);
